      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 py-12 border-b border-white/5">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="footer-social flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-white/50 hover:bg-[#449d46] hover:text-white transition-all"
                aria-label="LinkedIn"
              >
                <FaLinkedinIn />
              </a>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2.5">
              <li><Link to="/" className="text-white/45 text-sm hover:text-[#449d46] transition-all">Home</Link></li>
              <li><Link to="/about" className="text-white/45 text-sm hover:text-[#449d46] transition-all">About Us</Link></li>
              <li><Link to="/solutions" className="text-white/45 text-sm hover:text-[#449d46] transition-all">Solutions</Link></li>
              <li><Link to="/gril" className="text-white/45 text-sm hover:text-[#449d46] transition-all">GRIL</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2.5">
              <li><Link to="/events" className="text-white/45 text-sm hover:text-[#449d46] transition-all">Events</Link></li>
              <li><Link to="/etnow" className="text-white/45 text-sm hover:text-[#449d46] transition-all">Award</Link></li>
              <li><Link to="/nvidia-elite-partner" className="text-white/45 text-sm hover:text-[#449d46] transition-all">Nvidia Elite Partner</Link></li>
              <li><Link to="/career" className="text-white/45 text-sm hover:text-[#449d46] transition-all">Career</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2.5">
              ...
              <li><a href="mailto:info@globalinfoventures.com" className="text-white/45 text-sm hover:text-[#449d46] transition-all">Global Infoventures Pvt. Ltd.<br/>H-65 Sector 63, Noida</a></li>
              

              <li><a href="mailto:info@globalinfoventures.com" className="text-white/45 text-sm hover:text-[#449d46] transition-all">info@globalinfoventures.com</a></li>
              <li><a href="tel:+911234567890" className="text-white/45 text-sm hover:text-[#449d46] transition-all">+91 1234567890</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center py-4 text-sm text-white/30">
          ...
          <span className="footer-legal flex gap-4 mt-2 md:mt-0">
            <a href="#" className="hover:text-[#449d46] transition-all">Privacy Policy</a>
            <a href="#" className="hover:text-[#449d46] transition-all">Terms of Service</a>
          </span>
        </div>
      </div>
    </footer>

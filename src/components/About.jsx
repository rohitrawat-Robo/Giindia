          ...
          <div className="mt-16 grid items-center gap-12 lg:gap-16 lg:grid-cols-2">
            ...
            <div className="space-y-6">
              ...
              <h3 className="text-3xl font-bold text-slate-900 lg:text-4xl">
                Proud <span className="text-green-600">Elite Partner</span> of
                NVIDIA
              </h3>
              ...
              <p className="text-lg leading-relaxed text-gray-700">
                ...
                since the past 4 years. We have successfully completed more than
                <strong className="text-slate-900">
                  {" "}
                  30+ installations of NVIDIA DGX solutions
                </strong>{" "}
                till date and are actively delivering high-performance server
                solutions across the country.
              </p>

              <p className="text-lg leading-relaxed text-gray-700">
                We specialize in providing advanced systems, including the
                powerful
                <strong className="text-slate-900">
                  {" "}
                  DGX B200 to support AI and accelerated computing needs
                  nationwide
                </strong>
                . In addition, we also provide professional training on
                <strong className="text-slate-900"> NVIDIA servers</strong>,
                helping organizations and teams effectively deploy, manage and
                optimize their
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                ...
                <span className="rounded-full bg-green-100 px-4 py-2 text-sm font-medium text-green-700">
                  <span className="font-bold">DEPLOYED</span> 30+ DGX
                  Installations
                </span>
                <span className="rounded-full bg-green-100 px-4 py-2 text-sm font-medium text-green-700">
                ...
                <span className="rounded-full bg-green-100 px-4 py-2 text-sm font-medium text-green-700">
                  <span className="font-bold">SERVICE</span> NVIDIA Server
                  Training
                </span>
              </div>
            </div>
                ...
                <div className="relative flex flex-col items-center justify-center space-y-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className="mt-3 text-sm text-gray-600">
                      Trusted NVIDIA partner delivering cutting-edge AI
                      infrastructure
                    </p>
                  </div>

    ...
    >
      <div className="h-full bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
        ...
        <div className="p-5 md:p-6">
          ...
          {/* Date */}
          {date && (
            <p className="text-xs font-bold uppercase tracking-wider text-[#449d46] mb-2">
              {date}
            </p>
          )}

          {/* Title */}
          <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#449d46] transition-colors duration-300">
            {title}
          </h3>
          ...
          {/* View Award */}
          <div className="flex items-center gap-2 text-sm font-semibold text-gray-900 group-hover:text-[#449d46] transition-colors duration-300">
            <span>
              View Award
            </span>

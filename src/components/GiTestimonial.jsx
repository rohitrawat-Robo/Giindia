...
const clients = [
  { name: "ABESIT, Ghaziabad", image: images.abesitlogo },
  { name: "DBU, Punjab", image: images.dbu },
  { name: "GBU, Greater Noida", image: images.gbu },
  { name: "GLBITM, Greater Noida", image: images.glbitm },
  { name: "Gujarat Technological University, Ahmedabad", image: images.gtu },
];
      ...
      <div className="mb-4 flex items-center gap-1">
        {[...Array(5)].map((_, index) => (
          <Star
            key={index}
            size={16}
            className="fill-[#00a63e] text-[#00a63e]"
          />
        ))}
      </div>
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(#081C3A 1px, transparent 1px)",
      ...
      <div className="relative z-10">
        <div className="mx-auto mb-14 max-w-3xl px-6 text-center">
          ...
          <h2 className="text-3xl font-extrabold tracking-[-0.02em] text-[#081C3A] sm:text-4xl">
            Trusted by Colleges.
            <span className="block text-[#00a63e]">
              Loved by Faculty.
            </span>
          </h2>

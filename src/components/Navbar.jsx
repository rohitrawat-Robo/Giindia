      ...
      >
          ...
          <div className="flex items-center justify-between">
              ...
              {menuItems.map((item) => {
                return (
                  <Link
                    ...
                    className="relative font-medium text-[15px] tracking-wide text-gray-200 hover:text-[#449d46] transition-all duration-300 focus:outline-none rounded-lg px-1 py-1"
                  >
                    {item.label}
                  </Link>
                );
            ...
            <div className="hidden lg:block flex-shrink-0">
              <Link
                ...
                className="group relative flex items-center gap-2 rounded-lg bg-gradient-to-r from-[#449d46] to-[#5A8C00] px-5 py-2.5 text-sm font-semibold text-white transition-all duration-300 shadow-[0_4px_15px_-4px_rgba(118,185,0,0.3)] hover:-translate-y-0.5 hover:shadow-[0_8px_25px_-6px_rgba(118,185,0,0.5)] focus:outline-none focus:ring-2 focus:ring-[#449d46] focus:ring-offset-2 focus:ring-offset-[#08193A] overflow-hidden"
                aria-label="Login to your account"
              >
                <span className="absolute inset-0 bg-gradient-to-r from-[#8FD400] to-[#449d46] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
            ...
            <button
              ...
              className="flex flex-col gap-1.5 rounded-lg p-2 transition-colors lg:hidden focus:outline-none focus:ring-2 focus:ring-[#449d46] focus:ring-offset-2 focus:ring-offset-[#08193A]"
            ...
            >
              <span
                className={`block w-[26px] h-[2px] rounded-full transition-all duration-300 ${
                  scrolled ? "bg-[#449d46]" : "bg-gray-200"
        ...
        {mobileOpen && (
          <>
            ...
            >
              <div className="flex h-20 items-center justify-between border-b border-[#449d46]/20 px-6">
                <Link
                  to="/"
                  onClick={(e) => {
                    e.preventDefault();
                ...
                <button
                  onClick={handleMobileClose}
                  className="rounded-lg p-2 text-[#449d46] transition-all duration-200 hover:bg-[#449d46]/20 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-[#449d46]"
              ...
              <nav className="flex h-[calc(100%-5rem)] flex-col overflow-y-auto px-4 py-6">
                  ...
                  {menuItems.map((item) => {
                    return (
                      <Link
                        ...
                        target={item.external ? "_blank" : undefined}
                        rel={item.external ? "noopener noreferrer" : undefined}
                        className="block rounded-lg px-4 py-3 text-sm font-medium text-gray-300/90 transition-all duration-200 hover:bg-[#449d46]/10 hover:text-[#449d46]"
                      >
                        {item.label}
                      </Link>
                    );
                ...
                <div className="mt-6 border-t border-[#449d46]/20 pt-6">
                  <Link
                    to="/login"
                    onClick={handleMobileClose}
                    className="group relative flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-[#449d46] to-[#5A8C00] px-6 py-3 font-semibold text-white transition-all duration-300 shadow-[0_4px_15px_-4px_rgba(118,185,0,0.3)] hover:-translate-y-0.5 hover:shadow-[0_8px_25px_-6px_rgba(118,185,0,0.4)] focus:outline-none focus:ring-2 focus:ring-[#449d46] focus:ring-offset-2 focus:ring-offset-[#08193A] overflow-hidden"
                  >
                    <span className="absolute inset-0 bg-gradient-to-r from-[#8FD400] to-[#449d46] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>

    ...
    <div className="bg-light min-h-screen overflow-hidden">
      <SEO
        ...
        keywords={[
          "ET AI Conclave",
          "AI Awards",
          "Global Infoventures award",
          "NVIDIA Elite Partner recognition",
        ]}
        path="/etnow"
      />
                    ...
                    <div className="w-full">
                      ...
                      <div className="mb-6">
                        ...
                        >
                          ...
                          />
                          We are proud to share that GI Ventures has been
                          honored with a prestigious national award at the
                          Economic Times Conclave & Awards 2026 for its
                          groundbreaking contributions to AI infrastructure,
                        ...
                        >
                          This recognition celebrates our excellence in the
                          deployment of real-world, scalable AI infrastructure
                          and strategic AI up-skilling, reaffirming our
                          commitment to transforming cutting-edge innovation
                          into practical, high-impact solutions. By building
                          robust, scalable systems and enabling seamless
                          integration across industries, GI Ventures continues
                          to set new benchmarks for operationalizing AI at scale
                          in India.
                        </p>
                      </div>
                      ...
                      >
                        <div className="relative overflow-hidden rounded-lg shadow-xl hover:shadow-2xl transition-all duration-500 max-w-3xl mx-auto">
                          ...
                          >
                            ...
                            {/* Play Button Overlay */}
                            <div
                              className={`absolute inset-0 bg-black/30 flex items-center justify-center transition-all duration-500 ${isVideoHovered ? "opacity-100 bg-black/40" : "opacity-0"}`}
                            >
                            ...
                            <div
                              className={`absolute inset-0 border-2 border-white/30 rounded-lg transition-all duration-1000 ${isVideoHovered ? "scale-110 opacity-0" : "scale-100 opacity-100"}`}
                            ></div>
                          </a>
                        </div>
                      ...
                      <div className="mb-4">
                        ...
                        >
                          ...
                          institutionalized innovation—where AI adoption is
                          complemented by continuous workforce development.
                          Through our strategic up-skilling initiatives, we
                          empower professionals to effectively harness AI
                        ...
                        >
                          As we continue to drive India's digital transformation
                          journey, this recognition strengthens our resolve to
                          create long-term value and enhance the nation's global
                        ...
                        >
                          We thank you for being a part of our journey and look
                          forward to many more milestones together.
                        </p>
                      </div>
                    </div>
                  </div>
